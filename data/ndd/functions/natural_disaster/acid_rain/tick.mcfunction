...
execute if score ndd.time ndd.data matches 30 run schedule clear ndd:natural_disaster/acid_rain/tick
execute if score ndd.time ndd.data matches 30 run function ndd:natural_disaster/acid_rain/remove
