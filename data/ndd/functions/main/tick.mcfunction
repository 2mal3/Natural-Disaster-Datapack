...
# disease effects
execute as @e[tag=ndd.infected,scores={ndd.infected_t=600..},type=!#ndd.disease:not_infectable] at @s run particle dust 0.000 1.000 0.00 1 ~ ~1 ~ 0.2 0.2 0.2 0 1 normal
