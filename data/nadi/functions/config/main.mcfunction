...
# print Page
execute if score @s nadi.data matches 1 run function nadi:config/page_1
execute if score @s nadi.data matches 2 run function nadi:config/page_2
execute if score @s nadi.data matches 3 run function nadi:config/page_3


# tellraw the save Button
tellraw @s [{"text":"\n----------------","color":"gold"},{"text":"[Save]","color":"gold","clickEvent":{"action":"run_command","value":"/function nadi:config/end"}},{"text":"----------------","color":"gold"}]
