...
execute as @e[type=minecraft:area_effect_cloud,tag=nadi.hurricane_catch] at @s as @e[type=minecraft:falling_block,distance=..5] at @s run function nadi:natural_disasters/hurricane/random_motion
