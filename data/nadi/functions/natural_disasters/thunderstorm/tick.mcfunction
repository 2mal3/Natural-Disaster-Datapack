...
# Called from: nadi:natural_disasters/thunderstorm/create
# Datapack by 2mal3
...
# timer
schedule function nadi:natural_disasters/thunderstorm/tick 5s

scoreboard players remove $nadi.time nadi.data 1
execute if score $nadi.time nadi.data matches 0 run function nadi:natural_disasters/thunderstorm/remove
