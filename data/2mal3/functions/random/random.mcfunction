...
# generate
execute store result score .temp_0 2mal3.random run data get entity @e[type=minecraft:area_effect_cloud,tag=2mal3.random,limit=1] UUID[0]
execute store result score .temp_1 2mal3.random run data get entity @e[type=minecraft:area_effect_cloud,tag=2mal3.random,limit=1] UUID[1]
