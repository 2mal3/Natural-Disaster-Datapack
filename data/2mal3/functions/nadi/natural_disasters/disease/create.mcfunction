...
execute as @a[gamemode=!spectator,tag=!global.ignore] at @s as @e[type=!minecraft:player,type=!#2mal3:nadi/disease/not_infectable,tag=!nadi.not_infectable,tag=!global.ignore,tag=!global.ignore.kill,sort=random,limit=1,distance=..42] run function 2mal3:nadi/natural_disasters/disease/infect
...
# start disease
schedule function 2mal3:nadi/natural_disasters/disease/tick 2s
