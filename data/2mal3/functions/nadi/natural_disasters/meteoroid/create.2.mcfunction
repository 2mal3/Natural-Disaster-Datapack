...
# Called from: 2mal3:nadi/natural_disasters/meteoroid/create.1
# Datapck by 2mal3
...
execute as @e[tag=nadi.meteoroid.2,type=minecraft:armor_stand] at @s run setblock ~-4 ~-4 ~-4 minecraft:structure_block[mode=load]{name:"2mal3:nadi/meteoroid/meteoroid",rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
