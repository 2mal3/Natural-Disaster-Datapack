...
# Called from: 2mal3:nadi/natural_disasters/doline/tick
# Datapack by 2mal3
...
setblock ~-7 ~-1 ~-7 minecraft:structure_block[mode=load]{name:"2mal3:nadi/doline/void",posY:0,rotation:"NONE",mirror:"NONE",mode:"LOAD",integrity: 0.65f} replace
