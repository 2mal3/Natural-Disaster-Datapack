...
scoreboard players set $2mal3.random.in_0 2mal3.random -150
scoreboard players set $2mal3.random.in_1 2mal3.random 150
function 2mal3:random/random
execute store result entity @s Motion[0] double 0.01 run scoreboard players get $2mal3.random.out_0 2mal3.random

# Gennerates a random y speed from -0.50 to 1.50 and stores it in the falling block
scoreboard players set $2mal3.random.in_0 2mal3.random -50
scoreboard players set $2mal3.random.in_1 2mal3.random 150
function 2mal3:random/random
execute store result entity @s Motion[1] double 0.01 run scoreboard players get $2mal3.random.out_0 2mal3.random

# Gennerates a random z speed from -1.50 to 1.50 and stores it in the falling block
scoreboard players set $2mal3.random.in_0 2mal3.random -150
scoreboard players set $2mal3.random.in_1 2mal3.random 150
function 2mal3:random/random
execute store result entity @s Motion[2] double 0.01 run scoreboard players get $2mal3.random.out_0 2mal3.random
