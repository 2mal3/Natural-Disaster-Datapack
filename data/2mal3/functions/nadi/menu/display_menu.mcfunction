...
tellraw @s {"text":"\u2b24 Planet Minecraft Account","color":"blue","clickEvent":{"action":"open_url","value":"https://www.planetminecraft.com/member/2mal3/"},"hoverEvent":{"action":"show_text","contents":"*click*"}}
