# Description: Prints out debug informations about the world and the datapack
# AS: player, AT: player
...
execute store result score .temp_1 nadi.data run execute if entity @a

# Displays text
tellraw @s {"text":"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n"}
# nadi version; minecraft version; du version; player count; time; disaster on
tellraw @s [{"text":"Debug data: ","color":"gold"},{"score":{"name":".version","objective":"nadi.data"},"color":"red"},{"text":"; ","color":"gold"},{"score":{"name":".temp_0","objective":"nadi.data"},"color":"red"},{"text":"; ","color":"gold"},{"score":{"name":"$du.ver","objective":"load"},"color":"red"},{"text":"; ","color":"gold"},{"score":{"name":".temp_1","objective":"nadi.data"},"color":"red"},{"text":"; ","color":"gold"},{"score":{"name":".time","objective":"nadi.data"},"color":"red"},{"text":"; ","color":"gold"},{"score":{"name":".natural_disaster_on","objective":"nadi.data"},"color":"red"}]
tellraw @s {"text":""}
