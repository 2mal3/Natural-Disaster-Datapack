...
execute if score $nadi.random_natural_disasters nadi.config matches 1 if score $nadi.natural_disaster_on nadi.data matches 0 if score $nadi.time nadi.data matches ..0 run function 2mal3:nadi/choose_disaster
