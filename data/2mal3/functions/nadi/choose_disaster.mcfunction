...
execute if score $nadi.disease nadi.config matches 1 if score $2mal3.random.out_0 2mal3.random matches 7 run function 2mal3:nadi/natural_disasters/disease/create
execute if score $nadi.hurricane nadi.config matches 1 if score $2mal3.random.out_0 2mal3.random matches 8 run function 2mal3:nadi/natural_disasters/hurricane/create
execute if score $nadi.blizzard nadi.config matches 1 if score $2mal3.random.out_0 2mal3.random matches 9 run function 2mal3:nadi/natural_disasters/blizzard/create
